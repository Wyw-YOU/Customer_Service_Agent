...
class ProductRepository:
    ...
    async def list(self, category: str | None = None, max_price: float | None = None,
    ...
    async def search(self, keyword: str | None = None, budget: float | None = None,
                     category: str | None = None, limit: int = 10) -> list[Product]:
